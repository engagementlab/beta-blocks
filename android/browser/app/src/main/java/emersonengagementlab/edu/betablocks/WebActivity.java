package emersonengagementlab.edu.betablocks;
    ...
    void checkConnection() {
        ...
        if (mWifi == null || !mWifi.isConnected()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this)
                                            ...
                                            .setMessage("Beta Blocks requires an active internet connection. Please connect over wi-fi or mobile network and re-open the app.")
